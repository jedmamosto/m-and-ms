...
function DemoContent() {
  ...
  return (
    <main className="flex-grow max-w-6xl mx-auto w-full px-4 py-8 relative">
      ...
      <div className="flex flex-wrap justify-center items-center gap-3 mb-10 border-b-3 border-on-surface pb-6">
        <button
          onClick={() => handleTabChange("shop")}
          className={`min-h-[48px] px-6 font-label-bold text-xs uppercase tracking-wider border-3 rounded transition-all cursor-pointer ${
            activeTab === "shop"
                ...
                >
                  <div>
                    ...
                    <div className="flex border-b-2 border-on-surface mb-3.5 text-xs font-label-bold uppercase tracking-wider">
                      <button
                        ...
                        className={`flex-1 pb-1.5 border-b-2 transition-colors ${
                  ...
                  <div>
                    ...
                    <button
                      ...
                      className="w-full cta-primary min-h-[44px] uppercase text-xs tracking-wider"
                    >
                      Add to Local Bag
                    </button>
                  </div>
                  ...
                  <div className="fade-in space-y-6 text-center">
                    ...
                    <div className="flex gap-3 justify-center pt-2">
                      <button
                        ...
                        className="cta-primary min-h-[44px] text-xs uppercase"
                      >
                        Add Match to bag
                      </button>
                      <button
                        ...
                        className="px-4 py-2 border-3 border-on-surface bg-surface hover:bg-surface-container rounded font-button-text text-xs uppercase shadow-[2.5px_2.5px_0px_0px_var(--color-on-surface)] transition-all hover:translate-y-[2px]"
                      >
                        Retake Quiz
                      </button>
                    </div>
                ...
                <div className="flex items-center justify-between border-t-3 border-on-surface pt-4 mt-6">
                  {quizStep > 1 ? (
                    <button
                      ...
                      className="px-4 py-2 border-3 border-on-surface bg-surface hover:bg-surface-container rounded font-button-text text-xs uppercase cursor-pointer"
                    >
                      Back
                    </button>
                  ) : (
                  ...
                  {quizStep === 1 ? (
                    ...
                    <button
                      ...
                      className="cta-primary min-h-[44px] text-xs uppercase flex items-center gap-2"
                    >
                      {isQuizCalculating ? (
                        <>
          ...
          {checkoutSuccess ? (
            <div className="max-w-md mx-auto text-center p-8 bg-surface-container-lowest border-3 border-on-surface rounded-xl shadow-[6px_6px_0px_0px_var(--color-secondary)] space-y-6">
              ...
              <button
                ...
                className="cta-primary min-h-[44px] text-xs uppercase w-full"
              >
                Continue Shopping
              </button>
            </div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {["gcash", "paymaya", "cod"].map((method) => (
                        <button
                          ...
                          className={`py-3 border-2 border-on-surface rounded font-label-bold text-[10px] uppercase tracking-wide cursor-pointer transition-all ${
